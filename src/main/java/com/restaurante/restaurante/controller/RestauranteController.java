...
import com.restaurante.restaurante.model.RestauranteRegistroDTO;
...
public class RestauranteController {
    ...
    public String listarRestaurantes(Model model) {
        ...
        return "list/lista-restaurantes"; // Nombre de la plantilla HTML
    }
    ...
    public String mostrarFormularioRegistroRestaurante(Model model) {
        ...
        return "register/formulario-restaurante-registro"; // Nombre de la plantilla HTML
    }
    ...
    public String mostrarFormularioEditarRestaurante(@PathVariable("RUT") String RUT,
        ...
        if (restauranteOptional.isPresent()) {
            ...
            return "edit/formulario-restaurante-editar";
        } else {
