...
import com.restaurante.restaurante.model.PQRS;
import com.restaurante.restaurante.model.PQRSRegistroDTO;
import com.restaurante.restaurante.model.Restaurante;
import com.restaurante.restaurante.repository.RestauranteRepository;
import com.restaurante.restaurante.service.PQRSService;
...
public class PQRSController {
    ...
    public String mostrarFormularioPQRS(Model model) {
        ...
        return "register/formulario-pqrs-registro";
    }
    ...
    public String mostrarFormularioEdicionPQRS(@PathVariable("id") Long id, Model model, RedirectAttributes redirectAttributes) {
        ...
        if (pqrsOptional.isPresent()) {
            ...
            return "edit/formulario-pqrs-editar";
        } else {
