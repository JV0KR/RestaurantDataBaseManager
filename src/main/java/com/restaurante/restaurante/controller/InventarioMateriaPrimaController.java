...
import com.restaurante.restaurante.model.InventarioMateriaPrimaRegistroDTO;
import com.restaurante.restaurante.service.InventarioMateriaPrimaService;
import com.restaurante.restaurante.service.MateriaPrimaService;
...
public class InventarioMateriaPrimaController {
    ...
    public String listarInventario(Model model) {
        ...
        return "list/lista-inventario-materias-primas"; // Nombre de la plantilla HTML
    }
    ...
    public String mostrarFormularioRegistroInventario(Model model) {
        ...
        return "register/formulario-inventario-materias-primas-registro"; // Nombre de la plantilla HTML
    }
    ...
    public String guardarInventario(@Valid @ModelAttribute("datosFormularioInventario") InventarioMateriaPrimaRegistroDTO datosRegistro,
        ...
        if (result.hasErrors()) {
            ...
            return "register/formulario-inventario-materias-primas-registro"; // Volver al formulario si hay errores
        }
        try {
    ...
    public String mostrarFormularioEditarInventario(@PathVariable("id") Integer id, Model model, RedirectAttributes redirectAttributes) {
        ...
        if (inventarioOptional.isPresent()) {
            ...
            model.addAttribute("materiasPrimas", materiaPrimaService.obtenerTodasLasMateriasPrimas()); // Para el dropdown
            return "edit/formulario-inventario-materias-primas-editar"; // Nombre de la plantilla HTML
        } else {
    ...
    public String actualizarInventario(@PathVariable("id") Integer id,
        ...
        if (result.hasErrors()) {
            model.addAttribute("materiasPrimas", materiaPrimaService.obtenerTodasLasMateriasPrimas()); // Recargar para el dropdown
            return "edit/formulario-inventario-materias-primas-editar"; // Volver al formulario si hay errores
        }
        try {
