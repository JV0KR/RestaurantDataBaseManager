...
import com.restaurante.restaurante.model.Plato;
import com.restaurante.restaurante.model.PlatoRegistroDTO;
import com.restaurante.restaurante.service.PlatoService;
...
public class PlatoController {
    ...
    public String mostrarFormulario(Model model) {
        ...
        return "register/formulario-plato-registro"; // Sugerencia de nombre de plantilla
    }
    ...
    public String mostrarPaginaExito() {
        ...
        return "messages/exito"; // Puedes crear un exito-plato.html si quieres uno específico
    }
    ...
    public String mostrarPaginaError() {
        ...
        return "messages/error"; // Puedes crear un error-plato.html si quieres uno específico
    }
