...
import com.restaurante.restaurante.model.SedeRegistroDTO;
...
public class SedeController {
    ...
    public String listarSedes(Model model) {
        ...
        return "list/lista-sedes"; // Nombre de la plantilla HTML
    }
    ...
    public String mostrarFormularioNuevaSede(Model model) {
        ...
        return "register/formulario-sede-registro"; // Nombre de la plantilla HTML
    }
    ...
    public String mostrarFormularioEdicionSede(@PathVariable("id") Integer id, Model model, RedirectAttributes redirectAttributes) {
        ...
        if (sedeOptional.isPresent()) {
            ...
            return "edit/formulario-sede-editar"; // Nombre de la plantilla HTML
        } else {
