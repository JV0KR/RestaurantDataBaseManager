...
public class CargoController {
    ...
    public String mostrarFormularioRegistroCargo(Model model) {
        ...
        return "register/formulario-cargo-registro"; // Retorna el nombre de tu plantilla HTML para el formulario
    }
    ...
    public String mostrarFormularioEdicionCargo(@PathVariable("id") Long id, Model model, RedirectAttributes redirectAttributes) {
        Optional<Cargo> cargoOptional = cargoService.obtenerCargoPorId(id);
        ...
        if (cargoOptional.isPresent()) {
            ...
            return "edit/formulario-cargo-editar";
        } else {
    ...
    public String actualizarCargo(@PathVariable("id") Long id,
                                  ...
                                  RedirectAttributes redirectAttributes) {
        Cargo cargoActualizado = cargoService.actualizarCargo(id, datosActualizacion);
