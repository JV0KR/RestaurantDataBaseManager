...
import com.restaurante.restaurante.model.Area;
import com.restaurante.restaurante.model.AreaRegistroDTO;
import com.restaurante.restaurante.service.AreaService;
...
public class AreaController {
    ...
    public String listarAreas(Model model) {
        ...
        return "list/lista-areas"; // Nombre de la plantilla HTML
    }
    ...
    public String mostrarFormularioRegistroArea(Model model) {
        ...
        return "register/formulario-area-registro"; // Nombre de la plantilla HTML
    }
    ...
    public String mostrarFormularioEditarArea(@PathVariable("id") Integer id, Model model, RedirectAttributes redirectAttributes) {
        ...
        if (areaOptional.isPresent()) {
            ...
            return "edit/formulario-area-editar";
        } else {
