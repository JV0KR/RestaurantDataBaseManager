...
public class Empleado {
    ...
    private Cargo cargo; // Asegúrate de que el tipo sea Cargo1
    ...
    public Empleado(String cedula, String nombres, String numeroContacto, String correoCorporativo,
                    Restaurante restaurante, Sede sede, Cargo cargo, Area area) {
        this.cedula = cedula;
    ...
    public Empleado(String cedula, String nombres, String numeroContacto, String correoCorporativo,
                    Restaurante restaurante, Sede sede, Cargo cargo, Area area, Set<Horario> horarios) {
        this.cedula = cedula;
        this.nombres = nombres;
        this.numeroContacto = numeroContacto;
        this.correoCorporativo = correoCorporativo;
