...
import com.restaurante.restaurante.repository.EmpleadoRepository;
...
public class EmpleadoService {
    ...
    public Empleado registrarNuevoEmpleado(EmpleadoRegistroDTO datosRegistro) {
        ...
        Cargo cargo = cargoService.obtenerCargoPorId(datosRegistro.getIdCargo())
    ...
    public Empleado actualizarEmpleado(String cedula, EmpleadoRegistroDTO datosActualizacion) {
        ...
        if (empleadoExistenteOptional.isPresent()) {
            ...
            Cargo cargo = cargoService.obtenerCargoPorId(datosActualizacion.getIdCargo())
